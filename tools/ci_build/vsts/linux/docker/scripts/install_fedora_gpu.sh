...
aria2c -q -d /tmp 'http://developer.download.nvidia.com/compute/cuda/repos/fedora27/x86_64/cuda-repo-fedora27-9.2.148-1.x86_64.rpm'
dnf install -y /tmp/cuda-repo-fedora27-9.2.148-1.x86_64.rpm
dnf install -y cuda-9-2.x86_64
tar -zxvf /tmp/cudnn-9.2-linux-x64-v7.2.1.38.tgz --strip 1 -C /usr/local
ldconfig -v /usr/local/cuda/lib64
