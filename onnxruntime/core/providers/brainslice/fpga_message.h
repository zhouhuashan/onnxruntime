...
class FPGARequestMessage {
 ...
 private:
  ONNXRUNTIME_DISALLOW_COPY_AND_ASSIGNMENT(FPGARequestMessage);
  // Request.
...
class FPGAResponseMessage {
 ...
 private:
  ONNXRUNTIME_DISALLOW_COPY_AND_ASSIGNMENT(FPGAResponseMessage);
  // Response.
