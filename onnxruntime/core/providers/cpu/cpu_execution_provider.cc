...
class ONNX_OPERATOR_KERNEL_CLASS_NAME(kCpuExecutionProvider, kOnnxDomain, 9, DynamicSlice);
...
void RegisterOnnxOperatorKernels(std::function<void(KernelCreateInfo&&)> fn) {
  ...
  fn(BuildKernel<ONNX_OPERATOR_KERNEL_CLASS_NAME(kCpuExecutionProvider, kOnnxDomain, 9, DynamicSlice)>());
}
