...
// Instanciation of templated static variables.

template <>
MLDataType NonOnnxType<int>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<float>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<double>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<bool>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<char>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<unsigned char>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<signed char>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<unsigned short>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<short>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<__int64>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<unsigned int>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<unsigned __int64>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<union MLFloat16>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}
template <>
MLDataType NonOnnxType<std::string>::Type() {
  static NonOnnxType non_tensor_type;
  return &non_tensor_type;
}

template <>
MLDataType TensorType<int>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<float>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<bool>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<std::string>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<unsigned char>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<signed char>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<unsigned short>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<short>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<__int64>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<double>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<unsigned int>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<unsigned __int64>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
template <>
MLDataType TensorType<MLFloat16>::Type() {
  static TensorType tensor_type;
  return &tensor_type;
}
...
/*
MLDataType MapType<CPPType>::Type() { static MapType<CPPType> map_type; return &map_type; }
MLDataType MapType<TypeRegister<CPPType, Types...>>::Type() { static MapType map_type; return &map_type; }
MLDataType SequenceType<CPPType>::Type() { static SequenceType sequence_type; return &sequence_type; }
MLDataType SequenceType<TypeRegister<CPPType, Types...>>::Type() { static SequenceType sequence_type; return &sequence_type; }
MLDataType OpaqueType<T>::Type() { static OpaqueType opaque_type; return &opaque_type; }
*/
