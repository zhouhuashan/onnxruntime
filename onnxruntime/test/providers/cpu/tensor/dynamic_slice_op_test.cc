...
TEST(DynamicSliceTest, dynamic_half_slice_varied_types) {
  ...
  OpTester test3("DynamicSlice", 9);
  test3.AddInput  <std::string> ("data",   {3,3,2}, {"a","b","c","d","e","f",
                                                     "g","h","i","j","k","l",
                                                     "m","n","o","p","q","r"});
  test3.AddInput  <int64_t>     ("starts", {2},     {1,1});
  test3.AddInput  <int64_t>     ("ends",   {2},     {3,3});
  test3.AddOutput <std::string> ("output", {2,2,2}, {"i","j","k","l","o","p","q","r"});
  test3.Run();

  OpTester test4("DynamicSlice", 9);
  test4.AddInput  <float>    ("data",   {2,3,3}, {1.1f,2.2f,3.3f,4.4f,5.5f,6.6f,7.7f,8.8f,9.9f,
                                                  1.2f,2.3f,3.4f,4.5f,5.6f,6.7f,7.8f,8.9f,9.1f});
  test4.AddInput  <int32_t>  ("starts", {2},     {0,1});
  test4.AddInput  <int32_t>  ("ends",   {2},     {1,3});
  test4.AddOutput <float>    ("output", {1,2,3}, {4.4f,5.5f,6.6f,7.7f,8.8f,9.9f});
  test4.Run();

  OpTester test5("DynamicSlice", 9);
  test5.AddInput  <bool>    ("data",   {3,3,4}, {false,true,false,false,
  ...
  test5.AddInput  <int32_t> ("starts", {1},     {1});
  test5.AddInput  <int32_t> ("ends",   {1},     {2});
  test5.AddOutput <bool>    ("output", {1,3,4}, {false,true,false,false,
                                                 false,false,false,true,
                                                 true,false,true,true});
