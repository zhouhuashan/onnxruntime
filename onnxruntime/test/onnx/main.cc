...
int main(int argc, char* argv[]) {
  ...
  std::map<std::string, std::string> broken_tests{
      ...
      {"maxpool_2d_default", "gpu test failed"},
      {"lstm_with_peepholes", "gpu test failed"},
      {"maxpool_2d_pads", "gpu test failed"},
      {"maxpool_2d_precomputed_strides", "gpu test failed"},
      {"gru_seq_length", "gpu test failed"},
      {"maxpool_2d_precomputed_pads", "gpu test failed"},
      {"maxpool_2d_strides", "gpu test failed"},
      {"maxpool_2d_precomputed_same_upper", "gpu test failed"},
