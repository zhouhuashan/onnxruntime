...
std::vector<ITestCase*> LoadTests(const std::vector<std::experimental::filesystem::v1::path>& input_paths, const std::vector<std::string>& whitelisted_test_cases, ONNXRuntimeAllocator* env);
