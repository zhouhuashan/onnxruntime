...
if (MSVC)
  ...
  target_link_libraries(lotus_pybind11_state ${lotus_providers_whole_archive} ${lotus_framework_whole_archive} lotusIR_graph ${onnx_whole_archive} lotus_common ${lotus_EXTERNAL_LIBRARIES} ${PYTHON_LIBRARY_RELEASE})
else()
