...
if(lotus_BUILD_BENCHMARKS)
  add_executable(lotus_benchmark ${LOTUS_ROOT}/test/onnx/microbenchmark/main.cc)
  ...
  add_dependencies(lotus_benchmark lotus_providers lotus_framework lotusIR_graph onnx)
