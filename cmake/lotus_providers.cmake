...
target_include_directories(lotus_providers PRIVATE ${MLAS_INC} ${LOTUS_ROOT} ${eigen_INCLUDE_DIRS})
...
if (lotus_USE_CUDA)
    ...
    cuda_add_library(lotus_providers_cuda ${lotus_providers_cuda_cc_srcs} ${lotus_providers_cuda_cu_srcs} OPTIONS ${LOTUS_CUDA_CFLAGS})
    lotus_add_include_to_target(lotus_providers_cuda onnx protobuf::libprotobuf)
    add_dependencies(lotus_providers_cuda eigen ${lotus_EXTERNAL_DEPENDENCIES})
    target_include_directories(lotus_providers_cuda PRIVATE ${LOTUS_ROOT} ${lotus_CUDNN_HOME}/include ${eigen_INCLUDE_DIRS})
    ...
    if (WIN32)
        ...
        if (MSVC)
            target_compile_options(lotus_providers_cuda PRIVATE /wd4505) 
        endif()
...
if (lotus_USE_MKLDNN)
    ...
    target_include_directories(lotus_providers_mkldnn PRIVATE ${LOTUS_ROOT} ${eigen_INCLUDE_DIRS})
...
if (lotus_USE_TVM)
    ...
    target_compile_options(lotus_providers_nuphar PRIVATE ${DISABLE_WARNINGS_FOR_TVM})
endif()
