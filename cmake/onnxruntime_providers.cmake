...
if (lotus_USE_CUDA)
  ...
  if (NOT lotus_USE_TVM)
    list(REMOVE_ITEM onnxruntime_providers_cuda_cc_srcs "${LOTUS_ROOT}/core/providers/cuda/tensor/upsample.h")
    list(REMOVE_ITEM onnxruntime_providers_cuda_cc_srcs "${LOTUS_ROOT}/core/providers/cuda/tensor/upsample.cc")
  endif()
  source_group(TREE ${LOTUS_ROOT}/core FILES ${onnxruntime_providers_cuda_cc_srcs} ${onnxruntime_providers_cuda_cu_srcs})
  if(NOT WIN32)
  ...
  add_dependencies(onnxruntime_providers_cuda eigen ${lotus_EXTERNAL_DEPENDENCIES} ${onnxruntime_tvm_dependencies})
  target_include_directories(onnxruntime_providers_cuda PRIVATE ${LOTUS_ROOT} ${lotus_CUDNN_HOME}/include ${eigen_INCLUDE_DIRS} ${TVM_INCLUDES})
