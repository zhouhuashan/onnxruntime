...
target_compile_definitions(onnxruntime_providers PRIVATE ONNX_RUNTIME_EXPORTS=1 ONNX_RUNTIME_BUILD_DLL=1)
...
if (onnxruntime_USE_CUDA)
  ...
  if (NOT onnxruntime_USE_TVM)
    list(REMOVE_ITEM onnxruntime_providers_cuda_cc_srcs "${ONNXRUNTIME_ROOT}/core/providers/cuda/tensor/upsample.h")
    list(REMOVE_ITEM onnxruntime_providers_cuda_cc_srcs "${ONNXRUNTIME_ROOT}/core/providers/cuda/tensor/upsample.cc")
  endif()
  ...
  cuda_add_library(onnxruntime_providers_cuda ${onnxruntime_providers_cuda_cc_srcs} ${onnxruntime_providers_cuda_cu_srcs} OPTIONS ${CUDA_CFLAGS} -DONNX_RUNTIME_EXPORTS=1 -DONNX_RUNTIME_BUILD_DLL=1)
