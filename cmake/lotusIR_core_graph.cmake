...
add_library(lotusIR_graph $<TARGET_OBJECTS:lotus_core_common> ${lotusIR_graph_src} ${lotusIR_defs_src})
source_group(TREE ${LOTUS_ROOT}/core FILES ${lotusIR_graph_src})
source_group(TREE ${LOTUS_ROOT}/core FILES ${lotusIR_defs_src})

target_link_libraries(lotusIR_graph PUBLIC onnx)
add_dependencies(lotusIR_graph lotus_core_common)
