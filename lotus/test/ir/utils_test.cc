...
TEST(OpUtilsTest, ToStringTest) {
  ...
  TypeProto seq;
  seq.mutable_sequence_type()->mutable_elem_type()->mutable_sequence_type()->mutable_elem_type()->mutable_tensor_type()->set_elem_type(TensorProto_DataType::TensorProto_DataType_FLOAT);
