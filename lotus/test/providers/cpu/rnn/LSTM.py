    ...
    def execute(self):  # type: () -> Tuple[np.ndarray, np.ndarray]
        ...
        for x in np.split(self.X, self.X.shape[0], axis=0):
            ...
            if (self.input_forget):
                f = 1.0 - i  # this is what Lotus[RT] does
            else:
...
class LotusRTTestContext:
    ...
    def OneDirectionWeights():
        ...
        num_directions = 1
        hidden_size = LotusRTTestContext.hidden_size
        input_size = LotusRTTestContext.input_size
    ...
    def BidirectionalWeights():
        ...
        W1, R1, B1, P1 = LotusRTTestContext.OneDirectionWeights()
...
class LotusUnitTests:

    @staticmethod
    def LotusRT_TestLSTMBidirectionalBasic():
        print(LotusUnitTests.LotusRT_TestLSTMBidirectionalBasic.__name__)

        input = LotusRTTestContext.DefaultInput()
        W, R, B, P = LotusRTTestContext.BidirectionalWeights()
        lstm = LSTM_Helper(X=input, W=W, R=R, B=B, P=P, direction='bidirectional')
        Y, Y_h, Y_c = lstm.run()
        print_results(Y, Y_h, Y_c)

    @staticmethod
    def LotusRT_TestLSTMForwardNoBiasUsePeepholes():
        print(LotusUnitTests.LotusRT_TestLSTMForwardNoBiasUsePeepholes.__name__)
        input = LotusRTTestContext.DefaultInput()
        W, R, B, P = LotusRTTestContext.OneDirectionWeights()
        lstm = LSTM_Helper(X=input, W=W, R=R, P=P) # no bias
        Y, Y_h, Y_c = lstm.run()
        print_results(Y, Y_h, Y_c)

    @staticmethod
    def LotusRT_TestLSTMForwardInputForget():
        print(LotusUnitTests.LotusRT_TestLSTMForwardInputForget.__name__)
    ...
    @staticmethod
    def LotusRT_TestLSTMForwardClip():
        print(LotusUnitTests.LotusRT_TestLSTMForwardClip.__name__)
    ...
    @staticmethod
    def LotusRT_TestLSTMBackward():
        print(LotusUnitTests.LotusRT_TestLSTMBackward.__name__)
    ...
    @staticmethod
    def LotusRT_TestLSTMForwardHiddenState():
        print(LotusUnitTests.LotusRT_TestLSTMForwardHiddenState.__name__)
    ...
    @staticmethod
    def LotusRT_TestLSTMForwardCellState():
        print(LotusUnitTests.LotusRT_TestLSTMForwardCellState.__name__)
    ...
    @staticmethod
    def LotusRT_TestLSTMActivation():

        print(LotusUnitTests.LotusRT_TestLSTMActivation.__name__)
    ...
    @staticmethod
    def LotusRT_TestLSTMBatchReallocation():

        print(LotusUnitTests.LotusRT_TestLSTMBatchReallocation.__name__)
        seq_length = 2
        batch_size = 1
        input_size = 2
    ...
    @staticmethod
    def LotusRT_TestLSTMOutputWrite():

        print(LotusUnitTests.LotusRT_TestLSTMOutputWrite.__name__)
        seq_length = 2
        batch_size = 1
        input_size = 2
...
LotusUnitTests.LotusRT_TestLSTMForwardClip()
LotusUnitTests.LotusRT_TestLSTMBackward()
LotusUnitTests.LotusRT_TestLSTMForwardHiddenState()
LotusUnitTests.LotusRT_TestLSTMForwardCellState()
LotusUnitTests.LotusRT_TestLSTMActivation()
LotusUnitTests.LotusRT_TestLSTMBatchReallocation()
LotusUnitTests.LotusRT_TestLSTMOutputWrite()