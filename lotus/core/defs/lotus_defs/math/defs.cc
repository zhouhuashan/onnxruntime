...
#define REGISTER_ELEMENTWISE_BROADCAST_OPERATOR_SCHEMA(OpName)                                           \
  REGISTER_OPERATOR_SCHEMA(OpName)                                                                       \
      .Description(                                                                                      \
          "Performs element-wise binary " #OpName                                                        \
...
#define REGISTER_ELEMENTWISE_OPERATOR_SCHEMA(OpName, output)                                       \
  REGISTER_OPERATOR_SCHEMA(OpName)                                                                 \
      .Description("Element-wise " #OpName                                                         \
                   " of each of the input tensors. The first input tensor can be "                 \
                   "used in-place as the output tensor, in which case the " #OpName                \
                   " will be done in "                                                             \
