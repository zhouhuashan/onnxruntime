...
namespace Lotus {
#ifdef _WIN32
inline Common::Status FileOpenRd(const std::wstring& path, /*out*/ gsl::not_null<int*> p_fd) {
...
inline Common::Status FileOpenWr(const std::wstring& path, /*out*/ gsl::not_null<int*> p_fd) {
...
inline Common::Status FileOpenRd(const std::string& path, /*out*/ gsl::not_null<int*> p_fd) {
#ifdef _WIN32
...
inline Common::Status FileOpenWr(const std::string& path, /*out*/ gsl::not_null<int*> p_fd) {
#ifdef _WIN32
...
inline Common::Status FileClose(int fd) {
  int ret = 0;
#ifdef _WIN32
  ret = _close(fd);
#else
