...
CudnnReduceDescriptor::CudnnReduceDescriptor() : desc_(nullptr) {
}

CudnnReduceDescriptor::~CudnnReduceDescriptor() {
  if (desc_ != nullptr) {
...
Status CudnnReduceDescriptor::Set(cudnnReduceTensorOp_t op, cudnnDataType_t type, cudnnReduceTensorIndices_t indices) {
  if (!desc_)
